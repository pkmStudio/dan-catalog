...
watch(
  ...
  async (id) => {
    ...
    models.value = id
      ? (
          await $fetch<ApiResponse<VehicleModel[]>>('/api/vehicles/models', {
            query: { makeId: id }
          })
        ).data
      : []
...
<template>
  <div class="vehicle-selector">
    ...
    <div class="select-row">
      ...
      ><label
        >Модификация<select v-model="modification" :disabled="!modelId">
